...
- “创作设置”将日常使用的快速设置与高级提示词集中在同一入口。
- 快速设置用于调整读者、语气、深度、案例和 Emoji 等本次生成参数。
- 高级提示词可分别编辑全局规则、标题、正文、正文摘要和标签规则，支持创建并切换本地方案。
...
- 「创作设置」通过二级切换在快速设置与高级提示词之间切换，始终完整展示一个工作区。
- 快速设置保存在当前浏览器本地，并在生成和局部重新生成时使用。
- 高级提示词用于创建、切换和编辑全局规则、标题、正文、摘要与标签方案。
...
快速设置和高级提示词统一通过页面右上角的「创作设置」修改，不会影响 API Key。
